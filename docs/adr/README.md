...
| [0006](0006-no-component-library.md) | No component library: our own primitives, icons and pagination controls | accepted (supersedes the earlier "antd for primitives" decision) |
